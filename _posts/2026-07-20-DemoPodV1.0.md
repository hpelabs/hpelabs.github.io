...
5. When successfully logged in you are presented with a clickable link that launches your demo station. This is where you will work. Make sure you stay within the VPN connection when using a browser. If you connect to a site via your own browser, you will not have a network connection to the lab. You must stay within the Horizon terminal. Click on the **Demo Envir...** link.
   ...
   [![]( {{ site.baseurl }}/assets/images/HOLs/PresentationDemo/IMG034.png){: .bordered-image-thin}]( {{ site.baseurl }}/assets/images/HOLs/PresentationDemo/IMG034.png){:class="img-100pct"}{: data-lightbox="gallery"}
...
9. You should be presented with the iLO7 dashboard.
    ...
    [![]( {{ site.baseurl }}/assets/images/HOLs/PresentationDemo/IMG045.png){: .bordered-image-thin}]( {{ site.baseurl }}/assets/images/HOLs/PresentationDemo/IMG045.png){:class="img-100pct"}{: data-lightbox="gallery"}
...
12. You should be presented with a login prompt like the screen shot below.
    ...
    [![]( {{ site.baseurl }}/assets/images/HOLs/PresentationDemo/IMG046.png){: .bordered-image-thin}]( {{ site.baseurl }}/assets/images/HOLs/PresentationDemo/IMG046.png){:class="img-700"}{: data-lightbox="gallery"}

13. Enter the username of **Admin**/**HPent!123** and login to Thales.

    [![]( {{ site.baseurl }}/assets/images/HOLs/PresentationDemo/IMG047.png){: .bordered-image-thin}]( {{ site.baseurl }}/assets/images/HOLs/PresentationDemo/IMG047.png){:class="img-100pct"}{: data-lightbox="gallery"}
...
3. Click on the **Storage** card.
    ...
    [![]( {{ site.baseurl }}/assets/images/HOLs/PresentationDemo/IMG003.png){: .bordered-image-thin}]( {{ site.baseurl }}/assets/images/HOLs/PresentationDemo/IMG003.png){:class="img-900"}{: data-lightbox="gallery"}
...
4. The screenshot below is the NS204i-u controller. Again, you got here by going to **Host** -> **Hardware** -> **Storage** -> **Storage Controllers** to see this. Click on **View More** under the controller to see that the encryption mode is `Disabled`. This is expected because the NS204i-u does not provide any encryption capability at the controller level. In this case Encryption is handled at the storage device level, the 960GB storage devices themselves.
    ...
    [![]( {{ site.baseurl }}/assets/images/HOLs/PresentationDemo/IMG004.png){: .bordered-image-thin}]( {{ site.baseurl }}/assets/images/HOLs/PresentationDemo/IMG004.png){:class="img-900"}{: data-lightbox="gallery"}
...
5. To see the status of the 960GB storage devices, move down in the screen and click on the logical volume information in the **Volumes** card. Note that Encrypted is `False` in volume information, and for each 960GB device the Encryption Status is `Unencrypted`.
    ...
    [![]( {{ site.baseurl }}/assets/images/HOLs/PresentationDemo/IMG005.png){: .bordered-image-thin}]( {{ site.baseurl }}/assets/images/HOLs/PresentationDemo/IMG005.png){:class="img-900"}{: data-lightbox="gallery"}
...
6. Now let’s look at the MR416i-p harddrive controller. Again, we return to **Host** -> **Hardware** -> **Storage** -> **Storage Controllers** and we then click on the MR416i-p information.
    ...
    [![]( {{ site.baseurl }}/assets/images/HOLs/PresentationDemo/IMG006.png){: .bordered-image-thin}]( {{ site.baseurl }}/assets/images/HOLs/PresentationDemo/IMG006.png){:class="img-900"}{: data-lightbox="gallery"}

7. Click on **View More** to see the encryption area. Note that Encryption Mode is `UseLocalKey`.

    [![]( {{ site.baseurl }}/assets/images/HOLs/PresentationDemo/IMG007.png){: .bordered-image-thin}]( {{ site.baseurl }}/assets/images/HOLs/PresentationDemo/IMG007.png){:class="img-900"}{: data-lightbox="gallery"}
...
8. You can also look at the individual storage devices to see their encryption status. From **Host** -> **Hardware** -> **Storage** -> **Storage Drives**.
    ...
    [![]( {{ site.baseurl }}/assets/images/HOLs/PresentationDemo/IMG008.png){: .bordered-image-thin}]( {{ site.baseurl }}/assets/images/HOLs/PresentationDemo/IMG008.png){:class="img-900"}{: data-lightbox="gallery"}
